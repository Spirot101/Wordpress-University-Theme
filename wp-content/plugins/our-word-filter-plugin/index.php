...
class OurWordFilterPlugin {
  ...
  function ourMenu() {
    // 1. document title, 2. text that will show up in admin sidebar, 3. permission or capability to see the page, 4. slug (URL), 5. function name, 6. icon, 7. number that will control where the menu will show in admin dashboard
    ...
    // submenu in sidebar for options. 
    // 1. the menu you want to add the sub page to (use slug URL name), 2. document title, 3. text that you will see inside the admin sidebar, 4. capability, 5. slug (url), 6. function name
